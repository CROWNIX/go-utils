...
func MustShouldBindJSON(w http.ResponseWriter, r *http.Request, src any) (bool, *http.Request) {
...
func Write(w http.ResponseWriter, status int, contentType string, v any) {
...
func ErrorResponse(w http.ResponseWriter, r *http.Request, err error) *http.Request {
	if err == nil {
		return r
	}
...
func BindToPaginationInput(r *http.Request) primitive.PaginationInput {
	const (
		defaultPage     int64 = 1
